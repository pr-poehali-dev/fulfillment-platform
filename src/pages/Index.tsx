...
function Navbar({ active, setActive, onOpenCompare, compareCount }: {
  active: string;
...
function CatalogSection({ setActive, compareList, setCompareList, onOpenCompare }: {
  setActive: (s: string) => void;
  compareList: number[];
...
function ComparePage({ compareList, setCompareList, onClose }: {
  compareList: number[];
  setCompareList: React.Dispatch<React.SetStateAction<number[]>>;
  onClose: () => void;
}) {
